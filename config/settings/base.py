...
SECRET_KEY = 'django-insecure-kxwm71mrp8=4%thd$w^r69(cj162*cl#b_k(@f!me41d_*l2mr'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication', # <--- THIS MUST BE HERE
